    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <header className="bg-white border-b px-6 py-3 flex justify-between items-center shadow-sm">
        <div className="flex items-center gap-4">
          <Link href="/decor" className="text-gray-400 hover:text-gray-600">← Back to Search</Link>
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <p className="mt-4 text-[10px] text-gray-400 font-medium italic">
          Tip: You can drag, resize, and layer items to create your perfect event stage.
        </p>
      </main>
    </div>
  );
